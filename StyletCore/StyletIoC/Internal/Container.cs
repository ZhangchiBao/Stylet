...
using StyletCoreIoC.Internal.Creators;
using StyletCoreIoC.Internal.RegistrationCollections;
using StyletCoreIoC.Internal.Registrations;
using System;
    ...
    internal class Container : IContainer, IRegistrationContext
    {
        ...
        internal Type GetFactoryForType(Type serviceType)
        {
            ...
            if (this.factoryBuilder == null)
            {
                ...
                var assemblyBuilder = AssemblyBuilder.DefineDynamicAssembly(assemblyName, AssemblyBuilderAccess.Run); //AppDomain.CurrentDomain.DefineDynamicAssembly(assemblyName, AssemblyBuilderAccess.Run);
