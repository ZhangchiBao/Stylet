...
namespace StyletCore.Xaml
{
    ...
    public class ApplicationLoader : ResourceDictionary
    {
        ...
        {
            this.styletResourceDictionary = new ResourceDictionary() { Source = new Uri("pack://application:,,,/StyletCore;component/Xaml/StyletResourceDictionary.xaml", UriKind.Absolute) };
